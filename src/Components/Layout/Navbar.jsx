...
function NavBar() {
//Les valeurs des propriétés "to" des composants Link correspondent aux routes définies dans App; cliquer sur un Link équivaut à ajouter la valeur de "to" à l'URL de base du site, ce qui active la Route ayant cette même valeur pour la propriété path
